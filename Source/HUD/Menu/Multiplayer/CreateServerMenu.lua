		...
		GeneralTab =
		{
			...
			items = 
			{
				...
				GameMode =
				{
					...
					option = "GameMode",
					values = { "Free For All", "Team Deathmatch", "Voosh", "The Light Bearer", "People Can Fly", "Capture The Flag", "Duel", "Last Man Standing", "Race" }, --  , "Clan Arena", "Race"
					visible = { TXT.Menu.FreeForAll, TXT.Menu.TeamDeathmatch, TXT.Menu.Voosh, TXT.Menu.TheLightBearer, TXT.Menu.PeopleCanFly, TXT.Menu.CaptureTheFlag, TXT.Menu.Duel, TXT.Menu.LastManStanding, "Race"}, -- , "Clan Area"
					x	 = -1,
					y	 = 280,
					action = "",
					align = MenuAlign.Left,
